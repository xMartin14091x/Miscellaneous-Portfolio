...
const LoginPage = () => {
    const { user, signIn, signInWithGoogle, sendPhoneOTP, verifyPhoneOTP, authError, clearAuthError } = useAuth();
    const { t } = useLanguage();
        ...
        <div className="auth-page">
            <div className="auth-card">
                ...
                {authMode === 'email' && (
                    <form className="auth-form" onSubmit={handleEmailLogin}>
                        ...
                        <button type="submit" className="auth-submit-btn" disabled={loading}>
                            {loading ? <span className="btn-spinner"></span> : t.authLoginBtn}
                        </button>
                    </form>
                )}
                ...
                <div className="auth-footer">
                    <p>
                        {t.authNoAccount} <Link to="/signup">{t.authSignupLink}</Link>
                    </p>
                </div>
